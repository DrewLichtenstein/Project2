document.addEventListener('DOMContentLoaded', () => {
    ...
    if (localStorage.getItem("last_seen_chatroom") === null) {
        ...
        alert("Seeing message history from " + chatroom_name + ". Click a channel to enter.")
